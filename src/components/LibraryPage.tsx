import { Heart, Clock, Plus, Download, ListMusic, Bookmark, Music, Play } from "lucide-react";
...
export const LibraryPage = ({ onTrackSelect, onImageClick }: LibraryPageProps) => {
  ...
  return (
    <div className="h-full overflow-y-auto mobile-smooth-scroll bg-black">
      <div className="p-4 md:p-8">
        ...
        <div className="hidden md:grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-black p-6 rounded-lg border border-blue-500">
            <div className="flex items-center gap-4">
              ...
              {likedSongs.length > 0 ? (
                <div className="space-y-2">
                  {likedSongs.map((track, index) => (
                    <div
                      key={track.id}
                      className="music-card flex items-center gap-3 p-3 rounded-xl group cursor-pointer mobile-ripple bg-black/60 border border-blue-900 shadow-lg backdrop-blur-md transition-all hover:bg-blue-900/30"
                    >
                      ...
                      <img
                        src={track.image}
                        alt={track.title}
                          className="w-12 h-12 rounded-xl object-cover cursor-pointer shadow-md"
                          onClick={(e) => {
                            e.stopPropagation();
                            if (onImageClick) { onImageClick(track, likedSongs); }
                            onTrackSelect(track, likedSongs);
                          }}
                        />
                    ...
                    >
                      ...
                      <img
                        ...
                        alt={track.title}
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            if (onImageClick) { onImageClick(track, savedSongs); }
                            onTrackSelect(track, savedSongs);
                          }}
                        />
                        <div className="absolute inset-0 flex items-center justify-center rounded-xl bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity">
                          <Button
