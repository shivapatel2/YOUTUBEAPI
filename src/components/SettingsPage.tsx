...
export const SettingsPage = () => {
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 pb-20 md:pb-6 bg-black min-h-screen">
      {/* Header */}
      ...
      <div className="space-y-6">
        {settingSections.map((section) => (
          <div key={section.title} className="bg-card/70 backdrop-blur-md rounded-xl p-4 border border-blue-900/20 shadow-lg">
      ...
      <div className="bg-gradient-to-r from-primary/10 to-blue-500/10 rounded-lg p-4 border border-primary/20">
        ...
        <div className="flex items-center gap-4 text-xs text-muted-foreground">
          ...
          <span>•</span>
          <span>Developed by SpeedxShiva</span>
        </div>
      </div>
